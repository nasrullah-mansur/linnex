                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Phone Item Edit</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('admin.phone.update', $phone->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div id="output" class="mb-2">
                                        <img id="blah" src="{{ asset($phone->image) }}" alt="img" width="300">
                                    </div>
                                    <div class="controls">
